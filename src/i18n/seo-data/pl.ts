...
export const ARTICLE_DATA: Record<string, ArticleData> = {
    ...
    "sections": [
      {
        ...
        "body": "Proporcja obrazu to proporcjonalny związek między szerokością a wysokością obrazu, ekranu lub klatki wideo. Jest zapisywana jako dwie liczby oddzielone dwukropkiem, np. 16:9 lub 4:3. Pierwsza liczba to szerokość, a druga to wysokość. Proporcja 16:9 oznacza, że na każde 16 jednostek szerokości przypada 9 jednostek wysokości. Rzeczywisty rozmiar nie ma znaczenia. Obraz o wymiarach 160×90 pikseli i obraz o wymiarach 3840×2160 pikseli mają proporcje 16:9, ponieważ mają te same proporcje."
      },
      {
        ...
        "list": [
          ...
          "Kadrowanie: obraz jest przycinany, aby pasował, i część treści zostaje utracona",
      ...
      {
        "heading": "Dlaczego warto to wiedzieć",
        "body": "Proporcja obrazu to jedna z tych rzeczy, których nikt nie zauważa, dopóki nie jest źle, a wtedy jest to jedyna rzecz, którą widzą. Fotografia, film, strony internetowe, czasopisma, opakowania: duża część tego, co wygląda profesjonalnie, to po prostu właściwe proporcje. Kiedy tak nie jest, czujesz to, zanim potrafisz to nazwać. Coś jest za duże, za małe, dziwnie miękkie lub unosi się w zmarnowanej przestrzeni. Kiedy już zaczniesz to zauważać, nie możesz przestać, co jest nieco irytującym darem."
      }
    ],
    "conclusion": "Cały temat sprowadza się do jednego nawyku: zdecyduj o kształcie, zanim zdecydujesz o rozmiarze. Najpierw proporcja, potem piksele. Ustal tę kolejność, a reszta (kadrowanie, letterboxing, czarne pasy, rozmyte przesyłanie) w większości przestanie się dziać sama."
  },
  "how-to-calculate-aspect-ratio": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Ręczne obliczanie proporcji obrazu jest proste dla liczb całkowitych, ale szybko staje się żmudne dla nieregularnych wymiarów, takich jak 1847×923. Nasz darmowy Kalkulator Proporcji Obrazu natychmiast obsługuje dowolną szerokość i wysokość. Wprowadź swoje wartości i uzyskaj uproszczone proporcje, wartość dziesiętną, najbliższe standardowe dopasowanie oraz wartości CSS za jednym kliknięciem."
      },
      {
        "heading": "Dlaczego nie możesz po prostu ocenić tego na oko",
        "body": "Jest punkt, w którym ocena przestaje działać. Przesuwanie zdjęcia po stronie, aż będzie wyglądać dobrze, to doskonała metoda, ponieważ oko jest instrumentem, którym będzie oceniany wynik. Kod nie jest taki. Proporcje obrazu CSS, ustawienie eksportu, wysokość kontenera: każdy z nich przyjmuje liczbę, a liczba ta jest albo poprawna, albo różni się o jeden piksel, który pojawia się jako cienka linia na gotowym układzie. Projektowanie możesz dostosować na wyczucie. Rozmiary musisz obliczyć."
      }
    ],
    "conclusion": "Dwie zasady obejmują prawie każdy przypadek. Upraszczaj za pomocą GCD, gdy liczby na to pozwalają, i wracaj do wartości dziesiętnej plus najbliższe standardowe proporcje, gdy nie. Zachowaj proporcje całkowite dla wszelkich obliczeń i zaokrąglaj tylko na samym końcu. Ten jeden nawyk zapobiega większości błędów o jeden piksel, które pojawiają się jako cienka linia na gotowym układzie."
  },
  "aspect-ratio-social-media-guide-2026": {
    ...
    "description": "Każdy rozmiar i proporcje obrazu w mediach społecznościowych na rok 2026: Instagram, YouTube, TikTok, X, LinkedIn, Facebook i Pinterest. Zachowaj ten przewodnik w zakładkach.",
    ...
    "sections": [
      {
        ...
        "list": [
          "Brak nieoczekiwanego przycinania kluczowej treści",
      ...
      },
      {
        ...
        "body": "Instagram obsługuje trzy proporcje dla postów w kanale, a także Stories i Reels. W przypadku postów w kanale, pionowy format 4:5 (1080×1350) zapewnia najwięcej pionowej przestrzeni, co jest pożądane na powierzchni, którą ludzie przewijają.",
        "table": {
          "headers": [
            "Format",
            "Wymiary",
      ...
      },
      {
        ...
        "body": "TikTok jest całkowicie pionowy — zawsze używaj proporcji 9:16 w rozmiarze 1080×1920 dla najlepszej jakości. Kluczową treść umieszczaj na środku kadru i z dala od dolnych 20%, gdzie pojawiają się napisy i elementy interfejsu użytkownika.",
        "table": {
          "headers": [
            "Format",
            "Wymiary",
      ...
      },
      {
        ...
        "body": "Każda platforma rekompresuje to, co wysyłasz, i robi to lepiej, zaczynając od większej ilości danych. Przesłanie eksportu 1080 × 1350 z oryginalnego obrazu o szerokości 1080 pikseli nie daje koderowi nic do pracy; przesłanie wersji 2160 × 2700 tego samego obrazu i pozwolenie platformie na skalowanie w dół zazwyczaj wygląda wyraźnie czyściej w tej samej końcowej wielkości, szczególnie w przypadku tekstu i drobnych krawędzi. Wyjątkiem jest sytuacja, gdy platforma publikuje twardy limit. Uszanuj to, a następnie zbliż się do niego jak najbardziej."
      },
      {
        "heading": "Jeśli możesz stworzyć tylko jeden zasób",
        "body": "Stwórz go w proporcjach 4:5 w rozmiarze 1080 × 1350. Jest to najwyższy kształt akceptowany przez kanał Instagrama, co oznacza, że zajmuje najwięcej ekranu na powierzchni, która daje Ci najmniej, i czysto się przycina: przycięcie do środka do 1:1 dla kwadratowego umieszczenia, lub do 1.91:1 dla karty linku, a obiekt pozostaje tam, gdzie go umieściłeś. Idąc w drugą stronę, zaczynając od kwadratu i próbując osiągnąć 4:5, oznacza wymyślanie obrazu, który nigdy nie został sfotografowany."
      },
      {
        "heading": "Ostrzeżenie dotyczące przewodników takich jak ten",
        "body": "Każda liczba tutaj była poprawna w momencie pisania, a platformy zmieniają je bez zapowiedzi. Przewodnik jest punktem wyjścia, a nie autorytetem: przed ważną kampanią sprawdź własną dokumentację pomocy platformy, ponieważ jest to jedyna wersja, która aktualizuje się, gdy platformy to robią. Proporcje w ostatniej kolumnie są znacznie bardziej stabilne niż wymiary pikseli obok nich. 9:16 i 4:5 przetrwały kilka rund zmian specyfikacji, a budowanie w oparciu o proporcje, a nie liczbę pikseli, zapobiega przestarzałości tej tabeli."
      },
      {
        "heading": "Zdecyduj o kształcie przed zdjęciem",
        "body": "Większości problemów opisanych w tym przewodniku można uniknąć znacznie wcześniej, niż ludzie myślą. Wybór kadru przed sesją zdjęciową, zamiast odkrywania go podczas przesyłania, to różnica między decydowaniem o tym, co zostanie przycięte, a pozwoleniem platformie na podjęcie decyzji za Ciebie. Jest to również najtańsza dostępna edycja: przekadrowanie nic nie kosztuje przed naciśnięciem migawki, a po niej kosztuje jedną czwartą wartości zdjęcia."
      }
    ],
    "conclusion": "Twórz w oparciu o proporcje, a nie liczbę pikseli, i eksportuj większe niż docelowe. Te dwie nawyki przetrwają zmiany platform, czego nie zrobią dokładne liczby w tych tabelach. Zachowaj wszystko, co musi być czytelne, dobrze wewnątrz kadru i sprawdź własną dokumentację platformy, zanim cokolwiek, za co płacisz, zostanie opublikowane."
  },
  "16-9-vs-4-3-aspect-ratio": {
    "title": "Proporcje obrazu 16:9 vs 4:3 — Których powinieneś używać?",
    "description": "Przejrzyste porównanie proporcji obrazu 16:9 i 4:3: kiedy używać każdej z nich, ich historia, kluczowe różnice i przykłady rozmiarów pikseli.",
    "intro": "16:9 i 4:3 to dwie najbardziej historycznie znaczące proporcje obrazu w wideo i fotografii. Jeśli kiedykolwiek widziałeś czarne pasy na ekranie, po bokach lub na górze i na dole, to już zetknąłeś się z różnicą między nimi. Oto kompletne porównanie.",
    "sections": [
      {
        "heading": "Kluczowa różnica",
        "body": "16:9 jest szerszy i bardziej prostokątny (stosunek 1.78:1), podczas gdy 4:3 jest bardziej kwadratowy (stosunek 1.33:1). Obraz 16:9 jest o około 33% szerszy niż obraz 4:3 o tej samej wysokości. Ta różnica może wydawać się niewielka, ale jest bardzo zauważalna na ekranie."
      },
      {
        "heading": "Historia: Skąd się wzięły?",
        "body": "4:3 pojawiło się jako pierwsze, odpowiadając kształtowi wczesnych filmów kinowych 35mm, i pozostało standardem telewizyjnym przez większość XX wieku. 16:9 nie zostało odziedziczone po niczym. Zostało zaprojektowane. Pracując w SMPTE na początku lat 80., Kerns Powers wyciął prostokąty o równej powierzchni dla każdego używanego wówczas współczynnika proporcji, od telewizyjnego 1.33:1 do kinowego 2.35:1, i nałożył je na siebie, centrując je. Każdy prostokąt mieścił się w jednym zewnętrznym pudełku i zawierał jedno wewnętrzne pudełko, a oba te pudełka były bliskie 1.77:1. Ta liczba to prawie dokładnie średnia geometryczna skrajności: pierwiastek kwadratowy z 1.33 × 2.35 wynosi 1.77, a 16 ÷ 9 to 1.778. 16:9 to kształt, który marnuje najmniej miejsca na ekranie, uśredniając wszystko, co ktoś mógłby na nim wyświetlić."
      },
      {
        ...
        "list": [
          ...
          "Tworzysz miniatury dla YouTube"
        ]
      },
      {
      ...
      },
      {
        ...
        "body": "Obie konwersje kosztują dokładnie jedną czwartą obrazu, co jest więcej niż większość ludzi się spodziewa. Przejście z 16:9 na 4:3 przy tej samej wysokości oznacza przycięcie szerokości z 16 jednostek do 12, więc tracisz 25% kadru, a dzieje się to po bokach, gdzie często kadrowane są filmowane obiekty. Idąc w drugą stronę, z 4:3 na 16:9 przy tej samej szerokości, przycina wysokość z 12 jednostek do 9: również 25%, tym razem z góry i z dołu, gdzie znajdują się głowy i napisy. Żaden z kierunków nie jest zmianą rozmiaru. Jeśli treść ma znaczenie, przekadruj ją, zamiast pozwolić narzędziu do przycinania wybrać."
      },
      {
        "heading": "Ile kosztują Cię czarne pasy",
        "body": "Wyświetlanie treści 4:3 na ekranie 16:9 powoduje pojawienie się czarnych pasów po bokach (pillarboxing), a pasy te nie są jedynie kosmetyczne: obraz zajmuje 12 z 16 jednostek szerokości ekranu, więc jedna czwarta wyświetlacza nic nie robi. 55-calowy telewizor 16:9 ma 47.9 cala szerokości, więc to około 12 cali czerni. To jest praktyczny argument za nagrywaniem w proporcjach, w których będziesz publikować, zamiast planować poprawki później. Nie ma przycięcia, które odzyska jedną czwartą ekranu."
      },
      {
        "heading": "Decyduje to również o tym, jaki telewizor kupić",
        "body": "To nie tylko kwestia produkcji. Jeśli kochasz kino panoramiczne, telewizor 16:9 będzie wyświetlał prawie wszystko, co oglądasz, z czarnymi pasami u góry i na dole (letterboxing), ponieważ większość filmów kinowych jest szersza niż ekran, na którym je oglądasz. Jeśli głównie oglądasz telewizję naziemną i seriale streamingowe, 16:9 to dokładnie taki kształt, w jakim tworzone są te treści i prawie nic się nie marnuje. Właściwy ekran to ten, który pasuje do formatu, w którym faktycznie spędzasz wieczory, co warto ustalić przed wydaniem pieniędzy, a nie po."
      }
    ],
    "conclusion": "Nagrywaj i projektuj w 16:9, chyba że coś konkretnego skłania Cię do innego wyboru: publiczność korzystająca głównie z iPad, starszy projektor, archiwum do dopasowania. Jedyną rzeczą, której warto unikać, jest późne podejmowanie decyzji: obie konwersje kosztują jedną czwartą kadru, a to, którą ćwiartkę stracisz, to decyzja lepiej podjęta przez wizjer niż przez narzędzie do przycinania po fakcie."
  },
  "how-to-resize-image-without-losing-quality": {
    ...
    "intro": "Zmiana rozmiaru obrazu brzmi prosto, ale wykonana nieprawidłowo skutkuje rozmytymi, spikselowanymi lub zniekształconymi zdjęciami. Ten przewodnik wyjaśnia, kiedy i jak można zmieniać rozmiar obrazów bez widocznej utraty jakości.",
    "sections": [
      {
        "heading": "Zmniejszanie vs. Powiększanie",
        "body": "Istnieją dwa kierunki zmiany rozmiaru obrazu, które mają bardzo różne konsekwencje dla jakości. Zmniejszanie (zmniejszanie obrazu) prawie zawsze zachowuje jakość, ponieważ po prostu odrzucasz piksele. Powiększanie (zwiększanie obrazu) to miejsce, gdzie pojawiają się problemy z jakością, ponieważ oprogramowanie musi wymyślić dane pikseli, które nie istnieją w oryginale."
      },
      {
      ...
      {
        "heading": "O ile można powiększyć?",
        "body": "Ogólnie rzecz biorąc: powiększanie o 110–120% jest zazwyczaj niezauważalne dla większości widzów. Powiększanie o 150–200% powoduje zauważalną miękkość. Powiększanie powyżej 200% zazwyczaj powoduje wyraźną pikselizację i rozmycie. Narzędzia do powiększania oparte na sztucznej inteligencji (takie jak Topaz Gigapixel, Adobe Firefly i podobne) mogą czasami dawać akceptowalne wyniki przy powiększeniu 2–4× poprzez inteligentne generowanie szczegółów."
      },
      {
      ...
      {
        "heading": "Trzy sposoby, w jakie wygląda to źle",
        "body": "Źle zmieniony rozmiar objawia się na jeden z trzech sposobów: za duży, za mały lub rozmyty. Pierwsze dwa to problemy z kadrowaniem, a problemy z kadrowaniem można zazwyczaj naprawić, przesuwając coś. Trzeciego nie da się naprawić. Rozmycie to informacja, której już nie ma w pliku, i żadna ilość regulacji jej nie przywróci. Wiedza, na który z tych trzech problemów patrzysz, to tak naprawdę pytanie o to, czy jesteś pięć minut od zakończenia, czy zaczynasz od nowa od oryginału."
      }
    ],
    "conclusion": "Zachowaj plik główny. Prawie każdy problem z jakością w tym przewodniku wynika z tego, że ktoś nie ma już oryginału: nie możesz zmniejszyć rozmiaru czegoś, co już wyrzuciłeś, a żaden program do powiększania nie odzyska szczegółów, które nigdy nie zostały zarejestrowane. Eksportuj kopie, archiwizuj oryginał i zmieniaj jego rozmiar za każdym razem."
  },
  "install-aspect-ratio-calculator": {
    ...
    "description": "Zainstaluj Kalkulator Proporcji Obrazu jako aplikację, aby uzyskać natychmiastowy dostęp offline, skrót na ekranie głównym i doświadczenie bez rozpraszania uwagi — bez interfejsu przeglądarki, bez przeładowywania.",
    ...
    "sections": [
      {
        ...
        "body": "Kiedy instalujesz aplikację internetową (nazywaną również PWA, czyli Progressive Web App), Twoje urządzenie zapisuje skrót na ekranie głównym lub pulpicie i buforuje pliki aplikacji do użytku offline. Nie ma w tym udziału żadnego App Store i nic nie pobiera gigabajtów danych, ponieważ pliki są już w pamięci podręcznej przeglądarki. Instalacja po prostu promuje witrynę do pełnoprawnego doświadczenia aplikacji na Twoim urządzeniu."
      },
      {
        ...
        "list": [
          ...
          "Interfejs bez rozpraszania uwagi: brak paska adresu przeglądarki, kart czy paska narzędzi; kalkulator czysto wypełnia ekran",
          "Szybsze ładowanie: buforowane pliki ładują się natychmiast z lokalnej pamięci masowej, zamiast czekać na odpowiedź sieciową",
      ...
      },
      {
        ...
        "list": [
          "Stuknij przycisk Udostępnij (kwadrat ze strzałką skierowaną w górę) na pasku narzędzi Safari na dole ekranu",
      ...
      },
      {
        ...
        "body": "Na komputerze stacjonarnym z systemem Chrome lub Edge, poszukaj ikony instalacji w pasku adresu. Wygląda jak monitor z małą strzałką pobierania. Kliknij ją i potwierdź monit. W Edge opcja może również pojawić się w menu z trzema kropkami jako 'Aplikacje → Zainstaluj tę witrynę jako aplikację'. Po zainstalowaniu kalkulator pojawi się w Twoim Start menu (Windows) lub folderze Aplikacje (Mac) jak każda natywna aplikacja."
      },
      {
        "heading": "Jak odinstalować",
        "body": "Odinstalowanie jest tak samo łatwe jak instalacja. Na iOS, naciśnij i przytrzymaj ikonę na ekranie głównym i stuknij 'Usuń aplikację'. Na Android, naciśnij i przytrzymaj, a następnie przeciągnij do obszaru odinstalowania, lub przejdź do Ustawienia → Aplikacje. Na Chrome na komputerze stacjonarnym, otwórz aplikację, kliknij menu z trzema kropkami w oknie aplikacji i wybierz 'Odinstaluj Kalkulator Proporcji Obrazu'. W Edge, kliknij prawym przyciskiem myszy aplikację na pasku zadań lub w Start menu i wybierz Odinstaluj."
      },
      {
        "heading": "Dlaczego szybkość działania ma znaczenie",
        "body": "Prawie nikt nie siada z zamiarem wykonywania obliczeń proporcji obrazu. Pojawia się to w trakcie czegoś innego: plik ma zły kształt, kontener potrzebuje wysokości, wydruk ma zostać wysłany. Zawsze przeszkadza to w tym, co faktycznie robisz. To jest cała koncepcja projektowa tego narzędzia i powód, dla którego otwiera się ono natychmiast i nie wymaga konta: zrozum sytuację, podejmij decyzję, wróć do pracy."
      }
    ],
